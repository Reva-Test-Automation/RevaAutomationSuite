...
import org.openqa.selenium.Keys as Keys
		...
		//CustomKeywords.'applications.inSights.verifyPoliciesTab'()
		
		CustomKeywords.'applications.inSights.VerifyVersionHistoryStatus'(GlobalVariable.PolicyBeforeApprovalStatus)
		
		//CustomKeywords.'applications.inSights.EditCreatedPolicy'()
		
		CustomKeywords.'applications.inSights.ProvideApprovals'()
		
		CustomKeywords.'applications.inSights.VerifyVersionHistoryStatus'(GlobalVariable.PolicyAfterApprovalStatus)
