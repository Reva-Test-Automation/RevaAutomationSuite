...
import org.openqa.selenium.Keys as Keys
		...
		CustomKeywords.'onBoarding.CreateApplication.AddEnvironmentsWithExistingPolicy'(GlobalVariable.EnvironmentName, GlobalVariable.PolicySearchInput, GlobalVariable.PolicyDisplayName)
		// Creating Application > Adding Environment & Policy > Uploading Schema
		CustomKeywords.'onBoarding.CreateApplication.UploadSchemaJson'(GlobalVariable.SchemaJson)
