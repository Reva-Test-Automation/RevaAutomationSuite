...
public class inSights {
	...
	@Keyword
	public void ProvideApprovals() {
		CustomKeywords.'commonFunctions.browserUtils.openBrowser'()
		CustomKeywords.'loginPage.NavigateToLogin.NavigateUrl'()
		CustomKeywords.'loginPage.NavigateToLogin.Login'(GlobalVariable.TestUserName, GlobalVariable.TestUserPassword)
		ValidateApplication()
		WebUI.click(findTestObject('Object Repository/Applications/tab_Policies'))
		WebUI.waitForElementPresent(findTestObject('Object Repository/Applications/link_CreatedPolicyApprover'), 10)
		WebUI.click(findTestObject('Object Repository/Applications/link_CreatedPolicyApprover'))
